...
window.onload = async function () {
    ...
    document.getElementById("build-part").addEventListener("click", function () {
        ...
        web3.utils.fromAscii(expiry_date), web3.utils.fromAscii(product_price))

        window.pm.methods.buildPart(serial, part_type, creation_date, expiry_date, product_price).send({ from: window.accounts[0], gas: 1000000 }, function (error, result) {
