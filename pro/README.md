...
* Build products selecting their type
* Click on owned products to register them
* Fill next party address and click on "Change Ownership" to sell it to them

Wholesale:

* Automatically fill the products owned from the blockchain events
* Click on owned products to view the manufacturer address and other details 
* Fill next party address and click on "Change Ownership" to sell it to them

Retail:

* Automatically fill the products owned from the blockchain events
* Click on owned products to view the manufacturer address, previous owner address and other details
* Click on "Sell to customer" to send it to them
